$(document).ready(function(){
    ...
    $(document).on ("change", '#type_placa', function( event ){
        ...
        if ($('#type_placa').serialize().split("=")[1] == "Placa_Aligerada"){
            ...
            <div class="col-sm-2"><div class="form-group"><label># de placas:</label><input class="form-control count" type="number" name="num_placa" min="0" required></div></div>
    ...
    $(document).on ("click", '#mas_vigas', function( event ){
        ...
        $('#profile-box2').html(`${element}<div class="row" id="viga_${count_vigas}">
        <div class="col-sm-3"><div class="form-group"><label>Ancho:</label><input class="form-control" type="number" name="ancho_viga" step=".001" min="0" required></div></div>
        <div class="col-sm-3"><div class="form-group"><label>Largo:</label><input class="form-control" type="number" name="largo_viga" step=".001" min="0" required></div></div>
        <div class="col-sm-3"><div class="form-group"><label>Alto:</label><input class="form-control" type="number" name="alto_viga" step=".001" min="0" required></div></div>
        <div class="col-sm-3"><div class="form-group"><label># de vigas:</label><input class="form-control count" type="number" name="numero_viga" min="0" required></div>
        <input type="hidden" name="count_vigas" value=${count_vigas}></div>`)
    ...
    $(document).on ("click", '#mas_columnas', function( event ){
        ...
        <div class="col-sm-3"><div class="form-group"><label>Ancho:</label><input class="form-control" type="number" name="ancho_columna" step=".001" min="0" required></div></div>
        <div class="col-sm-3"><div class="form-group"><label>Largo:</label><input class="form-control" type="number" name="largo_columna" step=".001" min="0" required></div></div>
        <div class="col-sm-3"><div class="form-group"><label>Alto:</label><input class="form-control" type="number" name="alto_columna" step=".001" min="0" required></div></div>
        <div class="col-sm-3"><div class="form-group"><label># de columnas:</label><input class="form-control count" type="number" name="numero_columna" min="0" required></div></div>`)

# Generated by Django 3.0.6 on 2020-05-13 00:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0021_delete_historicalfolder'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='app.Folder', verbose_name='ubicacion')),
            ],
            options={
